...
set(TFT_PIN_DB_COUNT 8) # 8080 TFT data bus pin count
set(TFT_PIN_CS  29)  # 8080 TFT chip select pin
set(TFT_PIN_WR  19)  # 8080 TFT write pin
set(TFT_PIN_RS  20)  # 8080 TFT register select pin
set(TFT_PIN_RES 18)  # 8080 TFT reset pin
set(TFT_PIN_BLK 28)
...
set(TFT_BUS_CLK_KHZ 40000)
set(DISP_OVER_PIO 1)
set(PIO_USE_DMA 1)

set(TFT_DRV_USE_R61581 1)
